    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 max-w-4xl">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">Last updated: November 30, 2023</p>
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <ul className="list-disc pl-6 space-y-3">
              ...
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Forevergreen, 1060 Revenue Drive.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Forevergreen, accessible from{" "}
                <a href="https://www.forevergreen.earth/" className="text-blue-600 hover:text-blue-700 underline">
                  https://www.forevergreen.earth/
                </a>
              </li>
              <li>
            ...
            <p className="mt-4 mb-3">We use both Session and Persistent Cookies for the purposes set out below:</p>
            ...
            <p className="mt-4 mb-3">We may share Your personal information in the following situations:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Retention of Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Transfer of Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Delete Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Disclosure of Your Personal Data</h2>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Other legal requirements</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Links to Other Websites</h2>
            <p>
