...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    description:
      "Forevergreen was born with a mission to make sustainability simple and accessible for everyone.",
    stage: "seed",
    icon: Sprout,
  },
  {
    ...
    title: "First Funding",
    description:
      "Forevergreen wins the Kuzneski Cup at Pitt's Big Idea competition, marking its first major recognition.",
    stage: "sprout",
    icon: Leaf,
  },
  {
    ...
    description:
      "Forevergreen calculates its first user's carbon footprint, taking the first step toward measurable impact.",
    stage: "sprout",
    icon: Flower,
  },
  {
    ...
    description:
      "Forevergreen offsets its first customer's emissions, turning vision into real-world climate action.",
    stage: "growing",
    icon: Flower2,
  },
  {
    ...
    description:
      "Forevergreen hits 100,000 followers on Instagram, building one of the largest sustainability communities online.",
    stage: "growing",
    icon: TreeDeciduous,
  },
  {
    ...
    description:
      "The Forevergreen app goes live on the iOS App Store, empowering users to track and reduce their footprints.",
    stage: "mature",
    icon: TreePine,
  },
  {
    ...
    description:
      "Forevergreen reaches 100,000 subscribers on YouTube, expanding its educational mission globally.",
    stage: "mature",
    icon: Trees,
  },
];
